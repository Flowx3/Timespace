...
namespace TimeSpace
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            _customeTabPage.BtnSavePortal_Click(sender,e);
            _customeTabPage.BtnSaveMonster_Click(sender,e);
            ...
            eventHandlingScripts.AppendLine(File.ReadAllText("MonsterEvents.lua"));
